...
func main() {
	...
	log.Println("Service A connected to RabbitMQ")
...
func homeHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte("Service A is running on port 4010"))
}
...
func connectToRabbitMQ() (*amqp.Connection, *amqp.Channel, error) {
	...
	err = ch.QueueBind(
		SERVICE_A_QUEUE_NAME, // queue name
		"",                   // routing key
...
func consumeMessages(ch *amqp.Channel) {
	...
	log.Println("Service A started consuming messages")
